...
See https://github.com/pacviewer/jrpc-gateway/protoc-gen-jrpc-doc for more details.
`

// Version returns the currently running version of protoc-gen-jrpc-doc
func Version() string {
	return jrpc_doc.VERSION
}

// Flags contains details about the CLI invocation of protoc-gen-jrpc-doc
type Flags struct {
	appName     string
